...
(function ($) {
    $.extend({
        ...
        table: {
            ...
            //显示所有的数据字典
            selectDictLabelAll: function (datas) {
                // value: "'':请选择;1:FPC;2:电子料",
                let data = "'':请选择;";
                $.each(datas, function (index, dict) {
        ...
        operate: {
            ...
            // 新增bom信息
            addBom: function (id) {
                $.modal.open("新增" + table.options.modalName, $.operate.addUrl(id), "1100", "750");
            },
            // 新增入库信息
